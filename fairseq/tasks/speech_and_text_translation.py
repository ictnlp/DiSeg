...
from fairseq.data.audio.speech_and_text_translation_dataset import (
...
class SpeechAndTextTranslationTask(LegacyFairseqTask):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument("--eval-task", type=str, help="task for evaluation")
    ...
    def source_dictionary(self):
        if getattr(self.args, "eval_task", None) == "st":
            return None
    ...
    def build_generator(
        ...
        if (
            ...
            or getattr(self.args, "eval_task", "st") == "mt"
        ):
