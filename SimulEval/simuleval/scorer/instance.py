...
class Instance(object):
    def __init__(self, instance_id, source, target, eval_latency_unit):
    ...
    def recv_hypo(self, list_hypo: str, latency_unit: str = "word"):
        """
...
class AudioInstance(Instance):
    ...
    def load_audio_from_path(self, wav_path):
        ...
        samples, _ = soundfile.read(wav_path, dtype="float32")
