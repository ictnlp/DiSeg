...
@register_model("convtransformer_simul_trans_wav2vec")
class SimulConvTransformerModelWav2Vec(ConvTransformerModelWac2Vec):
    """
    Implementation of the paper:
    ...
    def add_args(parser):
        super(
            SimulConvTransformerModelWav2Vec, SimulConvTransformerModelWav2Vec
        ).add_args(parser)
        parser.add_argument(
            "--train-monotonic-only",
            action="store_true",
...
@register_model_architecture(
    "convtransformer_simul_trans_wav2vec", "convtransformer_simul_trans_espnet_wav2vec"
)
def convtransformer_simul_trans_espnet_wav2vec(args):
